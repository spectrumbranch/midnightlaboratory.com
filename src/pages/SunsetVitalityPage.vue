  ...
  <q-page class="row justify-evenly">
    <section class="col subpage">
      <article class="album-container">
        <h1 class="music-page-header zilla-slab">Sunset Vitality</h1>
        <div class="row">
...
import SunsetVitalityDescription from 'src/components/albums/sunset-vitality/SunsetVitalityDescription.vue';

const album = ref(albumMap[SunsetVitalityKey]);
